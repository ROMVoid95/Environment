...
public class PathUtils
{
     ...
     *
     * @param  ancestor
     *                      a potential ancestor {@link Path}.
     * @param  child
     *                      a potential child {@link Path}.
     * 
    ...
    {
        Checks.checkNotNull(path, "path should not be null");
        return path.replace(IOConstants.WINDOWS_DIRECTORY_SEPARATOR, IOConstants.UNIX_DIRECTORY_SEPARATOR);
    }
}
